...
// TODO: re-enable if GoogleTest provides a way for TYPED_TEST() to correctly
// macro-expand its arguments. this may not not happen anytime soon
#if 0
OA_DAY_COUNT_TEST(
	DayCountAct365Fixed,
	// day count tests
...
// instantiate test
TYPED_TEST(DayCountAct365FixedTest, Test)
{
	(*this)();
}
