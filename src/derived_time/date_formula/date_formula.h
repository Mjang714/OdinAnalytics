...
inline oa::time::Date operator+(const oa::time::Date& date_obj, const oa::derived_time::DateFormula& date_formula_rule) {
	return date_formula_rule.Adjust(date_obj);
}

inline oa::time::Date operator+(const oa::derived_time::DateFormula& date_formula_rule, const oa::time::Date& date_obj) {
	return date_formula_rule.Adjust(date_obj);
}
}
