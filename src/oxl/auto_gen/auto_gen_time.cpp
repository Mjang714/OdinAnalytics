// This is the registration function cpp that excel will use expose the function outwards.
...
extern "C" __declspec(dllexport) 
LPXLOPER12  oxlAddBusinessDays(LPXLOPER12 Base_Date_input, LPXLOPER12 Days_input, LPXLOPER12 Calendar_input)
{
  LPXLOPER12 xloper_result = static_cast<LPXLOPER12> (calloc(1, sizeof(xloper12)));
  try
 {
    oxl::xl_api::XlDictionary dictionary_input;
    if (oxl::xl_api::XLoperObj::IsMulti(Base_Date_input ) && (oxl::xl_api::XLoperObj::IsMulti(Days_input )))
    {
         dictionary_input = oxl::xl_api::XLoperObj::LPXloperToDictionary(Base_Date_input, Days_input);
    }
    else if (oxl::xl_api::XLoperObj::IsMulti(Base_Date_input))
    {
         dictionary_input = oxl::xl_api::XLoperObj::LPXloperToDictionary(Base_Date_input);
    ...
    else
    {
         ...
         {
           dictionary_input["Base_Date"] = oxl::xl_api::XLoperObj::LPXloperToDouble(Base_Date_input); 
           dictionary_input["Days"] = oxl::xl_api::XLoperObj::LPXloperToDouble(Days_input); 
           dictionary_input["Calendar"] = oxl::xl_api::XLoperObj::LPXloperToStr(Calendar_input); 

         }
    }
       auto intermediate_result = oxl::OxlAddBusinessDays(dictionary_input);
       oxl::xl_api::XLoperObj::ConvertToLPXloper(intermediate_result, xloper_result);
       return xloper_result;
   }
